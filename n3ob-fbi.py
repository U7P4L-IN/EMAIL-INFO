...
try:
	...
	print R + 'U7P4L_'.center(44)
	print "IN".center(44)
	print 'Fuck'.center(44)
	print 'Your System'.center(44)
	print W + ' '
	print ('U7P4L-F B I').center(44)
	print ' '
...
def baliho():
	try:
		...
		print R + 'U7P4L'.center(44)
		print "IN".center(44)
		print 'Fuck'.center(44)
		print 'Your System'.center(44)
		print ' ' + W
		print ('U7P4L_F B I').center(44)
...
[+] COUNTRY      :  BANGLADESH                         [+]
[+] ON GITHUB    :  U7P4L-IN                           [+]
[+] TOOL STATUS  :  FB SERVICE                      [+]
[+] TOOL VERSION :  FULL VERSION                                [+]
[+]====================================================[+]
...
def menu_reaction_ask():
  try:
	...
	cek = raw_input(R + 'U7P4L' + W + '/' + R + 'Bot' + W + '/' + R + 'Reaction' + W + ' >> ')
...
def bot():
  try:
	...
	cek = raw_input(R + 'U7P4L' + W +'/' + R +'Bot ' + W + '>> ')
